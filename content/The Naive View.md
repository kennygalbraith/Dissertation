In all natural languages, there are regularities that hold between the semantic-content of clauses and the canonical functions to which they serve to communicate:

For each of the the major clause-types,

> 1. Trevor sat down. ( *Declarative* $\rightarrow$  *Proposition* $\rightarrow$  *Assertion* )
...
>
 *Partitions* $\rightarrow$ *Question-Asking*
>
